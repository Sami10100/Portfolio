            ...
            <div className="grid items-center gap-8 lg:grid-cols-2">
              <div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <a href="https://calendly.com/hassamshabbir/30min" className="inline-flex items-center gap-[10px] rounded-[12px] bg-[#1A1B41] px-[26px] py-[15px] text-[14.5px] font-semibold text-white no-underline" target="_blank" rel="noopener noreferrer">
                    Book a Strategy Call →
                  </a>
                  <Link href="/free-audit" className="btn-cyan px-[26px] py-[15px] text-[14.5px]">
                    Get a Free Audit →
                  </Link>
                </div>
              </div>
