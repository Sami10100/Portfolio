      ...
      <Container>
        <div className="grid gap-9 lg:grid-cols-[.62fr_1.38fr]">
          <Reveal>
            ...
            <div className="mt-6 rounded-[14px] border border-white/[.1] bg-white/[.05] px-4 py-3">
              <div
                className="trustpilot-widget"
                data-locale="en-US"
                data-template-id="56278e9abfbbba0bdcd568bc"
                data-businessunit-id="6a3af60d9a89ab506eaa9dd9"
                data-style-height="52px"
                data-style-width="100%"
                data-token="a5546227-fa56-4a68-9948-9c1eca1250a9"
              >
                <a
                  href="https://www.trustpilot.com/review/sitesbrand.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Review SitesBrand on Trustpilot
                </a>
              </div>
            </div>
