      ...
      <Container>
        <div className="grid gap-[18px] lg:grid-cols-[1.35fr_1fr_1fr_1fr]">
          <Reveal>
            ...
            <a href="#cta" className="mt-6 inline-flex items-center gap-[10px] rounded-[12px] border border-[rgba(0,229,255,.4)] px-[22px] py-3 text-[14px] font-semibold text-[#00E5FF] no-underline">
              View All Services →
            </a>
        ...
        <div className="mt-[18px] grid gap-[18px] md:grid-cols-2 lg:grid-cols-4">
          ...
          <Reveal className="md:col-span-2">
            <div className="svc h-full rounded-[18px] border border-white/[.07] bg-white/[.025] p-6 transition-transform">
              ...
              <a href="#cta" className="mt-[14px] inline-block text-[13px] font-semibold text-[#00E5FF] no-underline">
                Learn More →
              </a>
            </div>
          </Reveal>
...
function TopService({ title, text }: { title: string; text: string }) {
  return (
    <div className="svc h-full rounded-[18px] border border-white/[.07] bg-white/[.025] p-6 transition-transform">
      ...
      <a href="#cta" className="inline-flex items-center gap-2 text-[13px] font-semibold text-[#00E5FF] no-underline">
        Learn More →
      </a>
    </div>
  );
...
function SmallService({ icon, title, text }: { icon: string; title: string; text: string }) {
  return (
    <div className="svc h-full rounded-[18px] border border-white/[.07] bg-white/[.025] p-6 transition-transform">
      ...
      <a href="#cta" className="text-[13px] font-semibold text-[#00E5FF] no-underline">
        Learn More →
      </a>
    </div>
  );
