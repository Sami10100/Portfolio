    ...
    <footer id="footer" className="border-t border-[rgba(26,27,65,.08)] bg-[#F4F5F6] px-7 pb-8 pt-[52px] text-[#1A1B41]">
      <div className="sb-container">
        <div className="grid gap-8 lg:grid-cols-[1.6fr_1fr_1fr_1fr_1.5fr]">
          <div>
            <Link href="/" className="inline-flex text-inherit no-underline" aria-label="SitesBrand home">
              <Logo />
            </Link>
          ...
          <FooterColumn title="Company" links={siteConfig.footer.company} href="/about" />
