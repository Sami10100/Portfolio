  ...
  return (
    <header className="nav-shell" style={{ boxShadow: scrolled ? "0 10px 30px -16px rgba(26,27,65,.3)" : "none" }}>
      <nav className="sb-container flex items-center gap-7 px-7 py-[14px]">
        <Link href="/" className="shrink-0 text-inherit no-underline" aria-label="SitesBrand home">
          <Logo />
        </Link>
        ...
        <div className="desktop-nav flex shrink-0 items-center gap-[10px]">
          <a className="rounded-[12px] border border-[var(--lborder)] px-[18px] py-[11px] text-[14px] font-semibold text-[var(--ltext)] no-underline" href={siteConfig.calendlyUrl} target="_blank" rel="noopener noreferrer">
            Book a Strategy Call
          </a>
          <Link className="btn-cyan px-[18px] py-[11px]" href="/contact#audit">
            Get a Free Audit
          </Link>
          <button
