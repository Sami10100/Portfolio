...
const caseStudies = [
  {
    ...
    resultWindow:
      "Results reflect the latest anonymized 6-month client review window for this engagement.",
            ...
            <div className="cases-wrap">
              <header className="case-story-head">
                ...
                <div className="case-meta">
                  ...
                  <small>{study.resultWindow}</small>
              ...
              <section className="case-results">
                <div className="case-results-intro">
                  ...
                  <p className="case-evidence-note">
                    {study.resultWindow} Sensitive records are withheld; individual results vary by scope, market, and implementation.
                  </p>
                </div>
