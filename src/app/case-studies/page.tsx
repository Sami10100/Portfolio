...
const caseStudies = [
  {
    ...
    reflection:
      "The breakthrough was not adding more data. It was giving every team the same moment of truth—and making the next action obvious.",
    person: "Hassam Shabbir",
    role: "Founder & Growth Strategist, SitesBrand",
  ...
  },
  {
    ...
    reflection:
      "Finance tools often make people feel behind. We designed this one to create calm: what changed, what matters, and what deserves attention next.",
    person: "Umaima Nabeel",
    role: "Creative Director & Lead Developer, SitesBrand",
  ...
  },
  {
    ...
    reflection:
      "In healthcare, conversion is not pressure. It is the removal of fear, confusion, and unnecessary effort between a person and the care they need.",
    person: "Warda Ali",
    role: "Head of Sales & Business Development, SitesBrand",
          ...
          >
            <div className="cases-wrap">
              ...
              <div className="case-build-grid">
                ...
                <aside>
                  <p className="case-section-label">Project reflection</p>
                  <blockquote>“{study.reflection}”</blockquote>
                  <div>
                    <span>{study.person.slice(0, 1)}</span>
                    <p>
