    ...
    <header className="about-header">
      <nav className="about-nav" aria-label="Main navigation">
        <Link className="about-logo" href="/" aria-label="SitesBrand home">
          <Image src="/assets/sitesbrand-wordmark-transparent.png" alt="SitesBrand" width={181} height={48} priority />
        </Link>
        ...
        <div className="about-links">
          ...
          <details className="about-menu">
            ...
            <div className="about-menu-panel right">
        ...
        <div className="about-actions">
          <a className="nav-call" href={siteConfig.calendlyUrl} target="_blank" rel="noopener noreferrer">
            Book a Strategy Call
          </a>
          <Link className="nav-audit" href="/#cta">Get a Free Audit</Link>
          <button className="theme-dot" type="button" aria-label="Theme toggle"><Glyph name="sun" /></button>
        </div>
  ...
  return (
    <div className="about-page">
      ...
      <main>
        ...
        <section className="about-light final-section">
          <div className="about-wrap final-card">
            <div>
              <SectionLabel>Ready When You Are</SectionLabel>
              <h2>Ready to build smarter growth<span>?</span></h2>
              <p>Bring us your growth goal. We will help you find the clearest path from attention to trust, leads, and revenue.</p>
              <div className="hero-cta">
                <a className="primary-cta" href={siteConfig.calendlyUrl} target="_blank" rel="noopener noreferrer">
                  Book a Strategy Call <span aria-hidden="true">-&gt;</span>
                </a>
                <Link className="light-secondary" href="/#cta">Get a Free Audit</Link>
              </div>
            </div>
            <div className="mini-window" aria-hidden="true">
              <div className="window-dots"><span /><span /><span /></div>
              <div className="window-grid">
                <div className="window-nav"><span>Home</span><span>Growth</span><span>Search</span><span>&lt;/&gt;</span></div>
                <div className="window-logo"><Image src="/assets/sitesbrand-icon-transparent.png" alt="" width={120} height={144} /></div>
  ...
  return (
    <footer className="about-footer" id="footer">
      <div className="footer-grid">
        ...
        <div><h3>Company</h3><Link href="/about">About Us</Link><Link href="/#cases">Case Studies</Link><Link href="/#process">Our Process</Link><Link href="/#cta">Contact Us</Link></div>
