...
const services = [
  ...
  },
  {
    ...
    image: "/assets/about/service-ai-automation.png",
    badge: "",
  },
  {
  ...
  },
  {
    ...
    image: "/assets/about/service-web-dev.png",
    badge: "",
  },
  {
    title: "Sales & Lead Generation",
    text: "Attract, engage, and convert high-intent leads into customers.",
    image: "/assets/about/service-lead-generation.png",
    badge: "",
  },
] as const;
      ...
      <main>
          ...
          <div className="about-wrap about-split hero-split">
            <div className="about-copy hero-copy">
              ...
              <div className="about-actions-row">
                <a className="about-btn about-btn-primary" href={siteConfig.calendlyUrl} target="_blank" rel="noopener noreferrer">
            ...
            <ImageStage
              src="/assets/about/about-clean-1.png"
        ...
        <section id="story" className="about-band about-light about-story">
          <div className="about-wrap about-split story-split">
            ...
            <ImageStage
              src="/assets/about/about-clean-2.png"
        ...
        <section className="about-band about-dark about-choice">
          <div className="about-wrap about-split">
            ...
            <ImageStage
              src="/assets/about/about-clean-3.png"
          ...
          <div className="about-wrap">
            <div className="services-head">
              ...
              <div className="services-orbit-stage" aria-hidden="true">
                ...
                <span />
                <Image
                  src="/assets/about/about-logo-platform.png"
                  alt=""
                  width={420}
                  height={420}
        ...
        <section className="about-band about-dark about-values">
          <div className="about-wrap about-split">
            ...
            <ImageStage
              src="/assets/about/about-clean-4.png"
          ...
          <div className="about-wrap final-card">
            <div>
              ...
              <div className="about-actions-row">
                ...
                <a className="about-btn light-secondary" href={`mailto:${siteConfig.email}`}>
                  Get a Free Audit
                </a>
              </div>
            </div>
            <Image
              src="/assets/about/about-cta-dashboard.png"
